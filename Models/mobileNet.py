...
DROPOUT_RATE = 0.25
OUTPUT_DIR = "Saved_Outputs_mobileNet "
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        os.path.join(OUTPUT_DIR, "best_model.keras"),  # Save model as .keras format
...
best_model = tf.keras.models.load_model(os.path.join(OUTPUT_DIR, "best_model.keras"))
